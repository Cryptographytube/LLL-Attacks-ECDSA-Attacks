...
# ═══════════════════════════════════════════════════════════════════════════
#  SIGHASH COMPUTATION  (z = message hash signed by ECDSA)
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
#  HNP-BASED LEAKAGE DETECTION ENGINE  (v2)
# ═══════════════════════════════════════════════════════════════════════════
"""
Math:
...
# ──────────────────────────────────────────────────────────────────────
#  GOD MODE: Filter · Multi-Depth Merge · SageMath Lattice
# ──────────────────────────────────────────────────────────────────────
...
def generate_sage_script(group_dir: str, sigs: list,
    ...
    script = f'''# ================================================================
# ECDSA HNP Lattice Attack  —  Auto-generated by ECDSA Forensic Pro
...
# ═══════════════════════════════════════════════════════════════════════════
#  LLL ATTACK ENGINE  ─ delegated to lll.py
...
def save_group_results(address: str, grp: dict):
    ...
    # ── SIGNATURES.csv  (auto-built for run_attack.py) ───────────────────────
    ...
    # ── {address}.txt  (manual input file for lll.py) ────────────────────────
...
def audit_address(address: str, limit: int):
    ...
    # ── Group by pubkey, analyze each group ──────────────────────────────
    groups        = group_by_pubkey(sigs)
    ...
    for grp in group_results:
        ...
        if grp['verdict'] in ('VULNERABLE', 'SUSPICIOUS'):
            ...
            # ── LLL ATTACK: triggered when VULNERABLE ──────────────────────
...
BANNER = """
╔══════════════════════════════════════════════════════════════════════╗
║  ECDSA FORENSIC PRO v9.0 — Real Bit-Leakage Detector               ║
