...
# ══════════════════════════════════════════════════════════════════════════════
#  LLL / CVP LATTICE ATTACK (SageMath required)
# ══════════════════════════════════════════════════════════════════════════════
...
def Attack(rsz_list, known_lsb_bits=None, limit=100, use_cvp=True, threshold_factor=2):
    ...
    # ── Lattice Reduction (Hybrid LLL + BKZ) ─────────────────────────────────
    L_matrix = None
    try:
...
# ══════════════════════════════════════════════════════════════════════════════
#  MAIN PIPELINE  —  called by ecdsa_forensic.py
# ══════════════════════════════════════════════════════════════════════════════
...
def run_lll_attack(address: str, rsz_list: list,
    ...
    for key_int in all_keys:
        ...
        if matched:
            ...
            # ── mathfound.txt (matched address + key) ────────────────────
            try:
...
# ══════════════════════════════════════════════════════════════════════════════
#  STANDALONE MODE  (python lll.py  /  sage lll.py  /  python lll.py wallet.txt)
# ══════════════════════════════════════════════════════════════════════════════
